...
(function (L09_Canvas) {
    ...
    L09_Canvas.flyingBirdHouse = flyingBirdHouse;
    function createBirdsHouse(_nBirds) {
        console.log("Create Birds");
        for (let i = 0; i < _nBirds; i++) {
            let _flyingBird = new flyingBirdHouse(40);
            L09_Canvas.birdsHouse.push(_flyingBird);
            console.log(_flyingBird);
        }
    }
    L09_Canvas.createBirdsHouse = createBirdsHouse;

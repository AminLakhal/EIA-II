...
(function (L04) {
    function generateContent() {
        for (let i = 0; i < L04.data.initialProduct.length; i++) {
            ...
            let initMenge = String(L04.data.initialProduct[i].quantity);
            let initName = String(L04.data.initialProduct[i].name);
            let initComment = String(L04.data.initialProduct[i].comment);
            let initDate = String(L04.data.initialProduct[i].date);

...
*/
    ...
    function drawSnowman() {
        console.log("Snowman");
        let x = getRandomInt(1920);
        let y = getRandomArbitrary(700, 900);
        let radius = 100;
        for (let i = 0; i < 3; i++) {
            crc2.beginPath();
    ...
    function drawBirdHouse() {
        ...
        let x = getRandomInt(1920);
        let y = getRandomArbitrary(500, 600);
        crc2.save();
        crc2.beginPath();
    ...
    function drawTree() {
        console.log("tree");
        let x = getRandomInt(1920);
        let y = getRandomArbitrary(550, 700);
        for (let i = 0; i < getRandomArbitrary(10, 50); i++) {
            crc2.save();
            crc2.beginPath();
            crc2.rect(x, y, 20, 80);
            crc2.closePath();
    ...
    function drawBirds() {
        let colors = ["red", "blue", "green", "yellow", "brown", "pink"];
        for (let i = 0; i < getRandomArbitrary(0, 10); i++) {
            let x = getRandomInt(1920);
            let y = getRandomArbitrary(100, 500);
            // Torso            
            crc2.save();
            let radius = 40;
            crc2.beginPath();
    ...
    function drawBirdsGround() {
        let colors = ["red", "blue", "green", "yellow", "brown", "pink"];
        for (let i = 0; i < getRandomArbitrary(0, 10); i++) {
            let x = getRandomInt(1920);
            let y = getRandomArbitrary(800, 1000);
            // Beine
            crc2.save();
            crc2.beginPath();
